...
CREATE TABLE `mc_drill-wall-and-take-core-record`  (
  ...
  `totalContainOilGasCoreLength` double NOT NULL COMMENT '累计含油气岩心长度',
...
CREATE TABLE `mc_log-well-blackboard-newspaper`  (
  ...
  `lithologyAndDescriptionOfHydrocarbonAndWater` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '岩性及油气水显示',
  `instrumentOperationAndCalibration` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '仪器运行及校验',
  `loggingCaptainSignature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '录井队长签字',
  `geologicalSupervisionSignature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '地质监督签字',
  ...
  `drillPressure` double NOT NULL COMMENT '钻压',
  `wheelRebolutions` int NOT NULL COMMENT '转盘转数',
  `displacement` double NOT NULL COMMENT '排量',
  `pumpingPressure` double NOT NULL COMMENT '泵压',
  ...
  `evaluateProjectsRemark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '备注',
  ...
  `wellWallTakeCoreTrueGetNumber` int NULL DEFAULT NULL COMMENT '井壁取芯实取颗数',
...
CREATE TABLE `mc_project-exception-report`  (
  ...
  `wellDrillTeamOrTheSuperviseSignature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '钻井队或监督签字',
  `geologySuperviseSignature` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '地质监督签字',
  PRIMARY KEY (`well_no`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mc_ration-fluorescence-analyse`  (
  ...
  `analyseParameterOilIndex` double NOT NULL COMMENT '油性指数',
  PRIMARY KEY (`serialNumber`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mc_sample-into-the-storage-note`  (
  ...
  `finishingDrillWellDepth` double NOT NULL COMMENT '完钻井深',
  `finishingDrillingDate` datetime NOT NULL COMMENT '完钻日期',
  `finishingDrillingPosition` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '完钻层位',
  `trimStatus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '现场整理，取样及保管情况',
  `theUnitDirectly` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '送样单位',
  `theUnitDirectlyPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '送样人',
  `theUnitDirectlyDate` datetime NOT NULL COMMENT '送样时间',
  `warehouseEntryResultsAndProblems` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '入库结果及存在问题',
  `acceptanceOfTheUnit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '验收单位',
  `acceptanceOfTheUnitPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '验收人',
  `acceptanceOfTheUnitDate` datetime NOT NULL COMMENT '验收时间',
  `rockCuttings_WellDepthToDepth` double NOT NULL COMMENT '岩屑井段',
  `rockCuttings_box` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '盒',
  `rockCuttings_package` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '包',
  `wellWallTakeCore_wellDepthToDepth` double NOT NULL COMMENT '井壁取芯井段',
  `wellWallTakeCore_sampleNumber` int NOT NULL COMMENT '井壁取芯颗数',
  `wellWallTakeCore_coringWay` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '井壁取芯方式',
  `drillWell_depthToDepth` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '钻井取芯井段',
  `drillWell_core_diameter` double NOT NULL COMMENT '钻井取芯岩心直径',
  `drillWell_coringCoefficient` int NOT NULL COMMENT '钻井取芯取芯次数',
  `drillWell_theLengthOfTheCore` double NOT NULL COMMENT '钻井取芯岩心长度',
  `drillWell_boxNumber` int NOT NULL COMMENT '钻井取芯盒数'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mc_threepeak-fivepeak-base-class`  (
  ...
  `sampleType` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '样品类型',
  `parameterS0` double NOT NULL COMMENT '变量值S0'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mc_xxwell-annular-tubes-measure-record`  (
  ...
  `annularTubes_steelGrade` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '套管钢级',
  `annularTubes_externalDiametery` double NOT NULL COMMENT '套管外径',
  `annularTubes_wallThickness` double NOT NULL COMMENT '套管壁厚',
  `annularTubes_soloLength` double NOT NULL COMMENT '套管单根长',
  `annularTubes_measurePerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '套管丈量人',
  `annularTubes_reviewPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '套管复查人',
  `annularTubes_remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '套管备注'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mc_xxwell-chlorine-titration-record`  (
  ...
  `sampleVolume` double NOT NULL COMMENT '取样体积',
  `chloringRoot` double NOT NULL COMMENT '氯根含量',
  `density` double NOT NULL COMMENT '密度',
  `viscosity` double NOT NULL COMMENT '粘度',
  `reviewPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '检验人',
  `beforeTheTitration` double NOT NULL COMMENT '滴定前',
  `afterTheTitration` double NOT NULL COMMENT '滴定后',
...
CREATE TABLE `mc_xxwell-dirll-tools-measure-record`  (
  ...
  `measurePerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '丈量人',
  `reviewPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '复查人',
...
CREATE TABLE `mc_xxwell-late-time-measure-record`  (
  ...
  `cycleTime` datetime NOT NULL COMMENT '循环一周时间',
  `downSideTime` datetime NOT NULL COMMENT '下行时间',
  `lineDelayTime` datetime NOT NULL COMMENT '管路延迟时间',
  `measureLatenessTime` datetime NOT NULL COMMENT '实测时间',
  `adoptLateTime` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '采用迟到时间',
  `adoptWellDepth` double NOT NULL COMMENT '采用井深',
  `measurePerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '测量人',
  `verifyPerson` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '审核人',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '备注',
  `innerRingEmpty` double NOT NULL COMMENT '内环空',
  `outsideRingEmpty` double NOT NULL COMMENT '外环空',
  `setOfCylinderDiameter` double NOT NULL COMMENT '套管直径',
  `snumberOfPumchings` double NOT NULL COMMENT '冲数（str/min）',
  `displacement` double NOT NULL COMMENT '排量（L/s）'
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
